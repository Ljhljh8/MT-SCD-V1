...
def validate_all_pairs(ctx, epoch):
    ...
    for batch in ctx.valloader:
        ...
        valid_13 = (mask1 > 0) & (mask3 > 0)
        label_change_13 = (mask1 != mask3) & valid_13
        if valid_13.any():
            labels_t1_t3_consistent = labels_t1_t3_consistent and torch.equal(
                (mask_bn != 0)[valid_13],
                label_change_13[valid_13],
            )
    ...
    stats = {
        ...
        "definition_checks": {
            ...
            "label_change_t1_to_t3_equal_mask_bn_on_valid": bool(
    ...
    try:
        ...
        if args.eval_only:
            ...
            payload = {
                ...
                "selected_validation_all_pairs": validate_all_pairs(
                    ctx,
                    ctx.start_epoch,
                ),
            }
