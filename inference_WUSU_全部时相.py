...
class Options:
    def __init__(self):
        ...
        parser.add_argument("--Net_name", type=str, default="TED-全部时相")
        ...
        parser.add_argument("--data_root", type=str,
                            default=r"/media/lenovo/课题研究/博士小论文数据/长时序变化检测/Long-term-SCD/wusu512_process/test")
        parser.add_argument("--load_from", type=str,
                            default=r"/media/lenovo/课题研究/博士小论文数据/长时序变化检测/Long-term-SCD/CMSCD_lxg/checkpoints/WUSU/WUSU_TED-0219/resnet34/epoch97_Score45.96_mIOU80.94_Sek30.97_Fscd64.46_OA94.45.pth")
